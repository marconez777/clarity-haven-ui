  ...
  const handleAnswer = () => {
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      submitTestResult({
        ...
        resultLevel: sum >= 40 ? "Positivo" : "Negativo",
        answers: newAnswers,
      });
    }
  };
                  ...
                  <CardContent className="pt-6 space-y-6">
                    <div className="text-center space-y-4">
                      <div className={`inline-flex flex-col items-center justify-center w-32 h-32 rounded-full border-4 ${
                        ...
                        <span className={`text-4xl font-bold ${finalScore >= 40 ? "text-red-500" : "text-primary"}`}>{finalScore}</span>
                      ...
                      {finalScore >= 40 && (
                        <p className="text-xl md:text-2xl font-bold text-red-600 mt-4">
                          Probabilidade Alta de Estar com Burnout
                        </p>
                      )}
                      ...
                      {finalScore >= 40 && (
                        <div className="pt-4">
                          <Button 
                            ...
                            onClick={() => handleWhatsAppClick('burnout_resultado', 'Olá, fiz o teste de Burnout no site, e quero saber mais sobre o tratamento.')}
                          >
