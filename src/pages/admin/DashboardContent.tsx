...
const DashboardContent = () => {
  ...
  const cards = [
    { title: 'Total de Posts', value: stats?.totalPosts || 0, icon: FileText, href: '/admin?tab=overview' },
    { title: 'Total de Páginas', value: stats?.totalPages || 0, icon: FolderOpen, href: '/admin/pages' },
    { title: 'Leads Total', value: leadStats?.totalLeads || 0, icon: Users, href: '/admin?tab=leads' },
    { title: 'Leads Hoje', value: leadStats?.todayLeads || 0, icon: TrendingUp, href: '/admin?tab=leads' },
    { title: 'Visitas Total', value: viewStats?.totalViews || 0, icon: Eye, href: '/admin?tab=analytics' },
    { title: 'Visitas Hoje', value: viewStats?.todayViews || 0, icon: Clock, href: '/admin?tab=analytics' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link to="/admin?tab=leads" className="text-sm text-primary hover:underline">
              Ver todos
            </Link>
          </CardHeader>
          <CardContent>
