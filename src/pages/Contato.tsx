        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Formulário */}
              {/* WhatsApp Destaque */}
              <div className="bg-[#25D366] rounded-lg p-6 shadow-lg mb-8">
                <div className="flex flex-col sm:flex-row items-center gap-4 text-white">
                  <div className="bg-white/20 p-4 rounded-full">
                    <MessageCircle className="w-8 h-8" />
                  </div>
                  <div className="text-center sm:text-left flex-1">
                    <h3 className="text-xl font-bold mb-1">Atendimento Rápido</h3>
                  ...
                  <Button
                    ...
                    size="lg"
                    className="bg-white text-[#25D366] hover:bg-white/90 font-semibold gap-2 w-full sm:w-auto"
                  >
