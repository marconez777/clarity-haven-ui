                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="pt-4">
                    <Button 
                      onClick={startTest} 
                      size="lg" 
                      className="w-full sm:w-auto py-4 px-10 text-lg font-semibold gap-2"
                    >
                      Iniciar Teste
                  ...
                  <CardContent className="pt-6 space-y-6">
                    <div className="text-center space-y-4">
                      <div className={`inline-flex flex-col items-center justify-center w-32 h-32 rounded-full border-4 ${
                        ...
                        <span className={`text-4xl font-bold ${finalScore >= 13 ? "text-red-500" : "text-primary"}`}>{finalScore}</span>
                      ...
                      {finalScore >= 13 && (
                        <p className="text-xl md:text-2xl font-bold text-red-600 mt-4">
                          Probabilidade Alta de Estar com Ansiedade
                        </p>
                      )}
                      ...
                      {finalScore >= 13 && (
                        <div className="pt-4">
                          <Button 
                            ...
                            onClick={() => handleWhatsAppClick('ansiedade_gad7_resultado', 'Olá, fiz o teste de Ansiedade no site, e quero saber mais sobre o tratamento.')}
                          >
