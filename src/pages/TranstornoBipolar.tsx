...
const TranstornoBipolar = () => {
  return <>
      <Helmet>
        ...
        <meta name="twitter:description" content="Tratamento especializado para transtorno bipolar com o Dr. Gabriel Lopes." />
              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                  ...
                  Oscilações intensas de humor, períodos de euforia seguidos por tristeza profunda?
                    <span className="block text-primary mt-3 md:mt-4 mb-[50px] md:mb-0">Você pode estar convivendo com o transtorno bipolar.</span>
                  </h1>
                  ...
                  <div className="flex flex-col gap-3 md:gap-4">
                    <Button size="lg" className="bg-gradient-to-r from-primary to-accent text-white hover:shadow-[var(--shadow-hover)] transition-all w-full sm:w-auto" onClick={() => handleWhatsAppClick('bipolar_hero')}>
                      🔹 Agende sua consulta
                    </Button>
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mt-12">
                  <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary/10 hover:text-primary" asChild>
                    <Link to="/teste-de-transtorno-bipolar">🔹 Faça o teste gratuito de transtorno bipolar</Link>
                  </Button>
                </div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <Button size="lg" className="bg-gradient-to-r from-primary to-accent text-white hover:shadow-[var(--shadow-hover)] transition-all" asChild>
                  <Link to="/teste-de-transtorno-bipolar">🔹 Iniciar teste gratuito</Link>
                </Button>
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center">
                  <Button size="lg" className="bg-gradient-to-r from-primary to-accent text-white hover:shadow-[var(--shadow-hover)] transition-all" onClick={() => handleWhatsAppClick('bipolar_tratamento')}>
                    🔹 Agende sua Consulta
                  </Button>
                </div>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="bg-gradient-to-r from-primary to-accent text-white hover:shadow-[var(--shadow-hover)] transition-all" onClick={() => handleWhatsAppClick('bipolar_cta_final')}>
                    🔹 Agende sua consulta
                  </Button>
                  <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary/10 hover:text-primary" asChild>
