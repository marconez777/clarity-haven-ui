                    ...
                    <div className="bg-accent/50 p-4 rounded-lg space-y-2">
                      ...
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li className="flex items-start gap-2">
                          ...
                          <span>50 perguntas sobre comportamentos, interações sociais e preferências</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-primary">•</span>
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                          {finalScore >= 25 ? (
                            ...
                            <>
                              Sua pontuação de {finalScore} pontos está abaixo do indicativo. Se você sente que suas 
                              experiências afetam sua qualidade de vida, não hesite em buscar orientação profissional.
                            </>
                          )}
                        </p>
                      </div>
