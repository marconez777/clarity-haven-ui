...
const Depressao = () => {
  return <>
      ...
      <div className="min-h-screen">
        <Navigation />
        <Breadcrumbs items={[{ label: "Especialidades", href: "/especialidades" }, { label: "Depressão" }]} />
        <main>
          {/* Hero Section */}
              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-foreground leading-tight">
                    ...
                    <span className="block text-primary mt-3 md:mt-4 mb-[50px] md:mb-0">Você pode estar enfrentando um quadro de depressão.</span>
                  </h1>
                  ...
                  <div className="flex flex-col gap-3 md:gap-4">
                    <Button size="lg" className="bg-gradient-to-r from-primary to-accent text-white hover:shadow-[var(--shadow-hover)] transition-all w-full sm:w-auto" onClick={() => handleWhatsAppClick('depressao_hero')}>
                      🔹 Agende sua consulta
                    </Button>
                  ...
                  <div className="mt-8 md:hidden animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
                    <img src={drGabrielImage} alt="Dr. Gabriel Lopes - Psiquiatra especialista em Depressão" className="w-full max-w-sm mx-auto h-auto rounded-2xl shadow-[var(--shadow-soft)]" />
                  </div>
                </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="bg-gradient-to-r from-primary to-accent text-white hover:shadow-[var(--shadow-hover)] transition-all" onClick={() => handleWhatsAppClick('depressao_cta_final')}>
                    🔹 Agende sua consulta
                  </Button>
                  <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary/10 hover:text-primary" asChild>
