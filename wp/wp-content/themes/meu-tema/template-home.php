    ...
    <section class="especialidades-home-section">
        <div class="container">
            ...
            <div class="especialidades-grid">
                <a href="<?php echo home_url( '/tdah' ); ?>" class="especialidade-card especialidade-card-primary">
                ...
                <a href="<?php echo home_url( '/ansiedade' ); ?>" class="especialidade-card especialidade-card-accent">
                ...
                <a href="<?php echo home_url( '/depressao' ); ?>" class="especialidade-card especialidade-card-primary">
                ...
                <a href="<?php echo home_url( '/transtorno-bipolar' ); ?>" class="especialidade-card especialidade-card-accent">
            ...
            <div class="specialties-grid">
                <div class="specialty-item">
                    <div class="specialty-icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/specialties/psiquiatria.png" alt="Psiquiatria">
                    </div>
                ...
                <div class="specialty-item">
                    <div class="specialty-icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/specialties/psicoterapia.png" alt="Psicoterapia">
                    </div>
                ...
                <div class="specialty-item">
                    <div class="specialty-icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/specialties/acupuntura.png" alt="Acupuntura">
                    </div>
                ...
                <div class="specialty-item">
                    <div class="specialty-icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/specialties/nutricao.png" alt="Nutrição">
                    </div>
                ...
                <div class="specialty-item">
                    <div class="specialty-icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/specialties/neuropsicologia.png" alt="Neuropsicologia">
                    </div>
            ...
            <div class="about-grid">
                <div class="about-content">
                    ...
                    <div class="about-buttons">
                        <a href="<?php echo home_url( '/dr-gabriel-lopes' ); ?>" class="btn btn-outline btn-lg">Conheço o doutor</a>
                ...
                <div class="about-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/dr-gabriel.png" alt="Dr. Gabriel Lopes">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="team-section">
        <div class="container">
            <div class="team-content">
                <h2 class="team-title">Profissionais diferenciados para cuidar do seu bem-estar</h2>
                <div class="team-features">
                    ...
                    <div class="team-feature">
                        <div class="feature-dot"></div>
                        <span>Empatia e atenção na consulta</span>
                    </div>
                    <div class="team-feature">
                        <div class="feature-dot"></div>
                        <span>Mestrado em psiconeuroimunologia</span>
                    </div>
                </div>
            </div>

            <div class="team-image-container">
                <img src="<?php echo get_template_directory_uri(); ?>/images/team-professionals.png" alt="Profissionais da equipe" class="team-image">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="mental-health-grid">
                <div class="mental-health-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/mental-health.png" alt="Pessoa relaxando na natureza">
                </div>

                <div class="mental-health-content">
                    <h2 class="mental-health-title">Atenção a sua saúde mental</h2>
                    <p class="mental-health-text">Diversos problemas podem afetar sua saúde mental e causar sofrimento como:</p>
                    <ul class="mental-health-list">
                        ...
                        <li>
                            <div class="list-dot"></div>
                            <span>Teste sua saúde mental.</span>
                        </li>
                    </ul>
                    <div class="mental-health-buttons">
                        <a href="<?php echo home_url( '/testes' ); ?>" class="btn btn-outline btn-lg">Saiba mais</a>
                        <a href="#agendar" class="btn btn-primary btn-lg">Agende sua consulta</a>
                    </div>
                </div>
            </div>
